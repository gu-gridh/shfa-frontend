...
export default {
  en: {
    message: {
      ...
      noResultsSub: "Hint: Try searching for EITHER a site OR a site with 3D models.",
      ...
      norwaydescriptiontext: 'Notes: The description is retrieved from Riksantikvaren/Kulturminnesøk and is not quality checked or translated.',
  ...
  sv: {
    message: {
      ...
      norwaydescriptiontext: 'OBS: Beskrivningen är hämtad från Riksantikvaren/Kulturminnesøk och är inte kvalitetskontrollerad eller översatt.',
